            ...
            <div class="category-content no-padding">
              <ul class="navigation navigation-main navigation-accordion">
                ...
                <li>
                  ...
                  <ul>
                    <li><a href="?page=data_kriteria">Master Kriteria & BObot</a></li>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li class="disabled"><a href="../../layout_5/LTR/index.html" id="layout5">Layout 5 <span class="label bg-slate-800">Coming soon</span></a></li>
                  </ul>
                </li>
                <li>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li><a href="http://tinyurl.com/jdymnat">Knowledgebase</a></li>
