...
?>
 <div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Ubah Data <span class="text-bold">Kriteria & Bobot</span></h5>
									<p>
		...
		<table width="100%" border="0" cellspacing="4" cellpadding="0" class="tabel_reg">
		   <tr>
			...
			<td><input class="form-control"name="inisial" type="text" size="40" value="<?php echo $inisial;?>" readonly> <br></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			<td>Atribut</td>
			<td><select for="form-field-select-2" class="cs-select cs-skin-elastic" name="atribut"><option value="benefit"<?php if($atribut=='benefit'){echo ' selected';};?>>Benefit</option><option value="cost"<?php if($atribut=='cost'){echo ' selected';};?>>Cost</option></select> <em>harus diisi</em></td>
		  </tr>
		  <tr>
			<td>Bobot</td>
			<td>
